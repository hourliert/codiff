...
const codiff = {
  ...
  confirmAutoViewedSync: (count) => ipcRenderer.invoke('codiff:confirmAutoViewedSync', count),
  setFileViewed: (request) => ipcRenderer.invoke('codiff:setFileViewed', request),
